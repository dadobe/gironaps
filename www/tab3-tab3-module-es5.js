(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
    ...
    /***/
    function rIl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DarkModeService", function () {
      ...
      var THEME_KEY = 'selected-app-theme';

      var DarkModeService = /*#__PURE__*/function () {
        function DarkModeService(_storage) {
          _classCallCheck(this, DarkModeService);

          this._storage = _storage;
        }

        _createClass(DarkModeService, [{
          key: "checkDarkmode",
          value: function checkDarkmode(dark) {
            this.darkMode = dark;
      ...
      DarkModeService.ctorParameters = function () {
        return [{
          type: _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]
        }];
      };

      DarkModeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], DarkModeService);
      /***/
    },
    ...
    function IqiF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_dark_mode_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../services/dark-mode.service */
      "8rIl"); // Import for taking & loading images


      var Camera = _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].Camera; // Import for enable DarkMode

      var Tab3Page = /*#__PURE__*/function () {
        function Tab3Page(_route, _afAuth, _authService, _loading, _darkModeService) {
          var _this2 = this;
          ...
          this.user = null; // from the INTERFACE created in auth.service.ts

          this.dummyAvatar = ''; //for darkmode

          this.darkMode = false;
          var prefersDark = window.matchMedia('(prefers-color-scheme: dark)');
          this.darkMode = prefersDark.matches; //Event Listener

          prefersDark.addEventListener('change', function (mediaQuery) {
            console.log('CHANGE: ', mediaQuery.matches);
            _this2.darkMode = mediaQuery.matches;
            document.body.classList.toggle('dark', _this2.darkMode);
          });
        }
        ...
        _createClass(Tab3Page, [{
          ...
          value: function ngOnInit() {
            ...
            this._authService.getUserData().subscribe(function (user) {
              _this3.user = user;

              if (!_this3.user.photoURL) {
                var name = user.displayName.split(' ').join('+');
                _this3.dummyAvatar = '/assets/images/dummy.jpeg';
              }
            });
          }
        }, {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 8:
                      this._authService.uploadAvatar(image.base64String).subscribe(function (res) {
                        loading.dismiss();
                      });
      ...
      Tab3Page.ctorParameters = function () {
        return [{
          ...
          type: _services_dark_mode_service__WEBPACK_IMPORTED_MODULE_9__["DarkModeService"]
        }];
      };

      Tab3Page = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-tab3',
    ...
    function nRCe(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".hero {\n  height: 30%;\n  background: var(--ion-color-primary);\n  color: #ffffff;\n}\n\nion-avatar {\n  margin: auto;\n  width: 70px;\n  height: 70px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
