(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    "5Bp7":
    /*!**********************************************!*\
      !*** ./src/app/services/biketour.service.ts ***!
      \**********************************************/

    /*! exports provided: BiketourService */

    /***/
    function Bp7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BiketourService", function () {
        return BiketourService;
      });
      /* harmony import */
      ...
      /*! @angular/common/http */
      "tk/3"); //Import to inject HttpClient ActivityService
      //Feature that allows to interact with rest apis


      var BiketourService = /*#__PURE__*/function () {
        function BiketourService(_httpClient) {
          _classCallCheck(this, BiketourService);

          this._httpClient = _httpClient;
        } //Method to fetch a particular activity (passed as parameter by an ID as number)


        _createClass(BiketourService, [{
          key: "getBiketour",
          value: function getBiketour(biketourID) {
            // the <Biketours> after the get method is to ensure to return the correct data types
            return this._httpClient.get(API + "/" + biketourID);
          } //Method to fetch all the available activities

        }, {
          key: "getAllBiketours",
          value: function getAllBiketours() {
            // the <Biketours> after the get method is to ensure to return the correct data types
      ...
      BiketourService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      BiketourService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], BiketourService); //url of api created in HEROKU

      var API = "https://bike-tours-api.herokuapp.com/bikeTours";
      /***/
    },
    ...
    function Gdn9(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @firebase/auth */
      "t6oF"); //import { auth } from 'firebase/app';


      var ProductService = /*#__PURE__*/function () {
        function ProductService(_db, _afAuth, _storage, _functions) {
        ...
        _createClass(ProductService, [{
          ...
          value: function getAllProducts() {
            return this._db.collection('products').valueChanges({
              idField: 'id'
            });
          }
        }, {
          ...
          value: function getOneProduct(id) {
            return this._db.doc("products/".concat(id)).valueChanges();
          }
          /*   deleteProduct(id) {
    ...
    /*! exports provided: TourismService */

    /***/
    function JjkH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TourismService", function () {
      ...
      var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @angular/common/http */
      "tk/3"); //Import to inject HttpClient TourismeSrvice
      //Feature that allows to interact with rest apis


      var TourismService = /*#__PURE__*/function () {
        function TourismService(_httpClient2) {
          _classCallCheck(this, TourismService);

          this._httpClient2 = _httpClient2;
        } //Method to fetch a particular activity (passed as parameter by an ID as number)


        _createClass(TourismService, [{
          key: "getTourism",
          value: function getTourism(tourismID) {
            // the <Tourism> after the get method is to ensure to return the correct data types
            return this._httpClient2.get(API_Tourism + "/" + tourismID);
          } //Method to fetch all the available activities

        }, {
          key: "getAllTourism",
          value: function getAllTourism() {
            // the <Tourism> after the get method is to ensure to return the correct data types
            return this._httpClient2.get(API_Tourism);
          }
        }]);
      ...
      TourismService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      TourismService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], TourismService); //url of api created in HEROKU

      var API_Tourism = "https://tourism-api-project.herokuapp.com/tourism";
      /***/
    },
    ...
    function fTLw(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @angular/core */
      "fXoL"); //Import to inject HttpClient EventService
      //Feature that allows to interact with rest apis


      var EventService = /*#__PURE__*/function () {
        function EventService(_httpClient3) {
          _classCallCheck(this, EventService);

          this._httpClient3 = _httpClient3;
        } //Method to fetch a particular activity (passed as parameter by an ID as number)
        ...
        _createClass(EventService, [{
          ...
          value: function getEvent(eventID) {
            ...
            return this._httpClient3.get(API_EVT + "/" + eventID);
          } //Method to fetch all the available activities
          ...
          value: function getAllEvents() {
            // the <Event> after the get method is to ensure to return the correct data types
            return this._httpClient3.get(API_EVT);
          }
        }]);
      ...
      EventService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], EventService); //url of api created in HEROKU

      var API_EVT = "https://event-api-project.herokuapp.com/event";
      /***/
    },
